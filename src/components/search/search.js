...
function Search(props) {
    ...
    return (
        <div className="w-full bg-slate-200 bg-opacity-90 absolute h-screen top-0 ">
            ...
            {
                props.searchValue ? <SearchResults showSearch={props.showSearch} setShowSearch={props.setShowSearch} searchValue={props.searchValue} products={props.products} addToCart={props.addToCart} results={props.results}/> : null
            }
