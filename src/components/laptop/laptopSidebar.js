...
import LaptopSideBarCategories from "./laptopSideBarCategories";

function valuetext(value) {
    return `${value}`;
}

function LaptopSidebar(props) {
    ...
    return (
        <div className="w-[15%] laptop:w-[25%] tablet:w-full">
            <div className="">
                <LaptopSideBarCategories products={props.products} selectCategory={selectCategory}/>
            </div>
